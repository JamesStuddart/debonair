...
namespace Debonair.Provider.MySql
{
    public class MySqlDataRepository<TEntity> : IDataRepository<TEntity> where TEntity : class, new()
    {
        private bool _disposed;
        private readonly IDataProvider<TEntity> _dataProvider;

        public MySqlDataRepository(MySqlProvider<TEntity> dataProvider)
        {
